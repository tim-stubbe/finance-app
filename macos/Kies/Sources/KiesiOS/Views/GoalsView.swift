...
/// Offene Ziele, rein lesend (kein Anlegen/Bearbeiten in dieser iOS-Scheibe -
/// die Web-App bleibt dafür der reichhaltigere Ort, siehe ROADMAP.md).
/// Kein numerischer Fortschrittsbalken: progress_percent wird serverseitig
/// aus GoalProgress/Kontostand berechnet, nicht als Rohspalte synchronisiert
/// (siehe KiesCore/Database/Models.swift-Kommentar zu Goal).
