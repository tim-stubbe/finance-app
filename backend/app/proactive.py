...
_SYSTEM = (
    ...
    "   ]}\n"
    "]}\n\n"
    "Prüfe alle Bereiche gleichrangig: Finanzen, Termine, Aufgaben, Projekte, "
    "Fristen, Dokumente, Gesundheit, Fahrten und Haus. Termine sind wichtig, "
    "aber melde genauso konkrete Auffälligkeiten oder sinnvolle nächste Schritte "
    "aus den anderen Bereichen. Bei Terminen nenne Datum/Uhrzeit; bündele eng "
    "zusammengehörige Punkte in EINER Meldung.\n"
